...
const CustomerHome = () => {
    ...
    const [activeLink, setActiveLink] = useState('/customerhome');
    ...
    const handleImageClick = (image, name) => {
        navigate('/customerdescription', { state: { image, name } });
    };
        ...
        <div>
            <header>
                ...
                <nav>
                    <a
                        href="/home"
                        onClick={(e) => { e.preventDefault(); handleLinkClick("/customerhome"); }}
                        className={activeLink === "/customerhome" ? 'active' : ''}
                    >
                        Home
                    </a>
                    <a
                        href="/profile"
                        onClick={(e) => { e.preventDefault(); handleLinkClick("/customerprofilepage"); }}
                        className={activeLink === "/customerprofilepage" ? 'active' : ''}
                    >
                        Profile
                    </a>
                    <a
                        href="/contact"
                        onClick={(e) => { e.preventDefault(); handleLinkClick("/customercontactus"); }}
                        className={activeLink === "/customercontactus" ? 'active' : ''}
                    >
                        Contact Us
                    </a>
                </nav>
